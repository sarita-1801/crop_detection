    ...
    <footer class="bg-gray-800 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <div class="flex mt-4 space-x-4">
                        ...
                        <a href="https://www.linkedin.com/" class="text-gray-400 hover:text-white">
                ...
                <div>
                    ...
                    <address class="not-italic text-gray-400">
                        <p class="mb-2">Pokhara-11, Ranipauwa</p>
                        <p class="mb-2">shilabushal@gmail.com|sthsarita18@gmailcom</p>
                    </address>
                </div>
                <div>
            ...
            <div class="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
                <p>&copy; 2025 AgroDetect. All rights reserved.</p>
            </div>
        </div>
    </footer>
